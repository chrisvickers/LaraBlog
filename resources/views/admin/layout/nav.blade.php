<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{ route('main.home') }}"><span class="text-danger">Lara</span>Blog</a>
            <ul class="user-menu">
                <li class="dropdown pull-right">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="{{ route('admin.settings.profile') }}"><span class="glyphicon glyphicon-user"></span> Profile</a></li>
